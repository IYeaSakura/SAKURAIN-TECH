...
2024年，埃隆·马斯克兑现了"开源算法"的承诺，将X.com（原Twitter）的"For You"推荐系统完整技术栈公之于众。这是一场**推荐系统架构范式的示威**——当大多数平台还在用几百个手工工程特征叠加梯度提升树（GBDT）做排序时，X团队直接押注了端到端的大模型方案：用基于Grok-1的巨型Transformer，从零开始学习"什么是好内容"。
