...
import { PlantUML } from '@/components/markdown/PlantUML';
...
const markdownComponents = {
  ...
  img: ({ src, alt }: { src?: string | Blob; alt?: string }) => <img src={typeof src === 'string' ? src : undefined} alt={alt} className="max-w-full h-auto my-4" />,
};
