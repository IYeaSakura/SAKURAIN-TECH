...
import {
  Zap, Binary, GitBranch, Network, Brain, FileCode,
  Play, Pause, RotateCcw, SkipBack, SkipForward, Shuffle, BookOpen,
  Maximize2, Minimize2, Upload, Check, X,
  // lucide-react 1.x 图标改名：Grid3X3→Grid3x3、BarChart3→ChartColumn（别名保持代码不变）
  Grid3x3 as Grid3X3, ChartColumn as BarChart3
} from 'lucide-react';
...
// 样式由 app/algo-viz/page.tsx 统一引入（Next.js 全局 CSS 必须在 app/ 目录导入）
